  ...
  <main-layout>
    <div class="content">
      ...
      <div class="section-content">
        ...
        <p>
          Sound Realms are very proud and excited to announce a collaboration with ACE Gamebooks and author Jonathan Green to create an audio adventure version of <i>Dracula, Curse of the Vampire</i> (2021) for the Sound Realms platform.
        </p>
        <p>
Oscar Carlquist: "We are very pleased to present the next upcoming addition to Sound Realms and I can't wait to start creating some truly haunting and immersive soundscapes for <i>Dracula: Curse of the Vampire</i>. The interactive gamebook version of Bram Stoker's classic is masterfully written by Jon Green and taking this into the audio realm will be as much of an honour as a challenge that we here at Sound Realms are ready to embrace with enthusiasm and dedication!"
</p>
        <p>
Jonathan Green: "I am thrilled that Sound Realms are turning <i>Dracula: Curse of the Vampire</i> into the first audio ACE Gamebook and can't wait to hear how they bring the horror to life through the use of soundscapes and top-notch voice talent. It's going to be bloodcurdlingly brilliant!"
        </p>

      </div>
      <img src="../../assets/dracula/dracula-download.png" class="image" />
